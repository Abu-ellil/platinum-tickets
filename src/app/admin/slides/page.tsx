        ...
        <div className="space-y-6 md:space-y-8">
                ...
                <SheetContent side={language === "ar" ? "right" : "left"} className="p-0 border-none w-full sm:max-w-md">
                    <div className="flex flex-col h-full bg-white">
                        <div className="p-6 border-b flex items-center justify-between">
                            <h2 className="text-xl font-black">{language === 'ar' ? 'إضافة سلايد جديد' : 'Add New Slide'}</h2>
            ...
            <div className="grid grid-cols-1 gap-4 md:gap-6">
                {slides.map((slide, index) => (
                    <div key={slide.id} className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden flex flex-col lg:flex-row p-3 md:p-4 gap-4 md:gap-6 group">
                        ...
                        <div className="flex-1 flex flex-col justify-between py-1">
                            <div>
                                <div className="flex items-center justify-between">
                                    <h3 className="text-lg md:text-2xl font-black text-gray-900 truncate pr-2">{slide.title}</h3>
